    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-3xl font-semibold text-white mb-2">Join ConSERVERtive</h1>
          <p className="text-gray-300">Create your account and fight for internet freedom</p>
        </div>
        <SignUp 
          appearance={{
            elements: {
